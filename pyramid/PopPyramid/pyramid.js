...
//to center text between axes--- manually adjust this....or somehow base on length of text?
...
svg.append("g")
    ...
    .attr("transform","translate(" + pointB + "," + (svgHeight + 10) + ")");
...
//Add to max value in scales above if you want to remove the if/else statements from labels below.
//value 40 is used because it is approximate length of the labels. is there a way to derive this number from the actual length of drawn labels, instead?
